...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='consensus_backup',
            namespace='r1',
            executable='consensus_backup_node',
            name='consensus_backup_node_1',
            parameters=[
                {'max_vel': 0.25},
                {'K': 1.0},
                {'name': 'r1'},
