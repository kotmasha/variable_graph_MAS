...
os.system("python -m cProfile -o profileSim.txt main_single_sim.py easyTestPolygon.yml")
...
#p.sort_stats('time').print_stats(10) # Sorts by total time in each function, including sub-functions
